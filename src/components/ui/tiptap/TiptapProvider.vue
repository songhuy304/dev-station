...
function findNodePositionById(id: any) {
...
<template>
  <div
    data-slot="tiptap-provider"
    class="dark:bg-input/30 border-input rounded-md border bg-transparent px-3 py-1 transition-[color,box-shadow] outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive"
  >
    <slot />
  </div>
</template>
